<div class="header-content">
    <h2><i class="fa fa-table"></i> Data Input <span></span></h2>
        ...
        <div class="col-md-12">
            <div class="panel rounded shadow">
                <!-- <div class="panel-heading">
                    <div class="pull-left">
                        <h2 class="panel-title">Identitas</h3>
                    </div>
                    ...
                    <form action="#" class="form-horizontal">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control input-sm rounded" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Dropdown Konvensional</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Choosen</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                            <label class="col-sm-2 control-label">Multiple Chosen Select</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Check Button</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Input Basic</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Upload Type 1</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Upload Type 2</label>
                                <div class="col-sm-10">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Input Tag</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group" id="dp">
                                <label class="col-sm-2 control-label">Date Inline</label>
                                <div class="col-sm-10">
